  ...
  const productCategories = [
      ...
      items: [
        {
          ...
          description: "Full HD smart TV perfect for small gatherings, meetings, or bedroom setups with built-in streaming apps",
          price: "₹1,500/day",
          features: [
        ...
        },
        {
          ...
          description: "4K UHD smart TV ideal for medium-sized rooms, corporate events, or premium home entertainment",
          price: "₹2,500/day",
          features: [
        ...
        },
        {
          ...
          description: "Massive 4K QLED TV for large venues, showrooms, or creating an immersive home theater experience",
          price: "₹5,000/day",
          features: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          name: "Webcasting Kit",
          description: "Equipment for live streaming events or video conferencing",
          price: "₹3,500/day",
          features: ["HD camera", "Streaming encoder", "Audio interface"]
        }
      ]
              ...
              {category.items.map((item, itemIndex) => (
                ...
                >
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      <button className={`flex items-center text-white font-medium py-2 px-4 rounded-lg transition duration-300 ${category.buttonClass}`}>
                        <FiShoppingCart className="mr-2" />
                        Rent Now
                      </button>
                    </div>
